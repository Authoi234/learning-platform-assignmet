        ...
        <div className='container'>
            ...
            <div className='lg:flex md:block'>
                ...
                <div>
                    ...
                    <p className='py-3 text-lg'>Learn {courseDetail.title} by video. In video our teachers teach you coding directly.After learning you should know basics of of previous courses</p>
                </div>
            </div>
            <div>
